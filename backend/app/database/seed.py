...
def seed_database(reset: bool = True):
    ...
    readings_seed = [
        # Worker w-01 (Rajesh Kumar / MRPL-EMP-4091) - 30-Day Sum: 7,420.0 ppm·min (13 distinct shift readings)
        {
            "id": "scan-1001",
            "worker_id": "w-01",
        ...
        },
        {
            ...
            "humidity_pct": 65.0,
            "strip_age_days": 19.0,
            "estimated_dose": 560.0,
            "equivalent_8h_twa_ppm": 1.17,
            "confidence": 0.95,
            "status": "MODERATE",
            "expiry_status": "VALID",
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 66.0, "a_star": 10.8, "b_star": 24.2}, "delta_e_baseline": 36.5})
        },
        {
            "id": "scan-1003",
            "worker_id": "w-01",
        ...
        },
        {
            ...
            "humidity_pct": 69.0,
            "strip_age_days": 16.0,
            "estimated_dose": 680.0,
            "equivalent_8h_twa_ppm": 1.42,
            "confidence": 0.93,
            "status": "MODERATE",
            "expiry_status": "VALID",
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 61.2, "a_star": 13.1, "b_star": 26.5}, "delta_e_baseline": 41.2})
        },
        {
            "id": "scan-1006",
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=5, hours=6),
            "shift": "Shift A",
            "temperature_c": 27.5,
            "humidity_pct": 58.0,
            "strip_age_days": 15.0,
            "estimated_dose": 390.0,
            "equivalent_8h_twa_ppm": 0.81,
            "confidence": 0.95,
            "status": "LOW",
            "expiry_status": "VALID",
            "image_quality_score": 0.96,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 74.8, "a_star": 7.2, "b_star": 19.3}, "delta_e_baseline": 25.1})
        },
        {
            "id": "scan-1007",
            "worker_id": "w-01",
        ...
        },
        {
            ...
            "humidity_pct": 66.0,
            "strip_age_days": 11.0,
            "estimated_dose": 620.0,
            "equivalent_8h_twa_ppm": 1.29,
            "confidence": 0.93,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.94,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 63.8, "a_star": 11.9, "b_star": 25.1}, "delta_e_baseline": 38.0})
        },
        {
            "id": "scan-1009",
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=11, hours=2),
            "shift": "Shift A",
            "temperature_c": 28.0,
            "humidity_pct": 60.0,
            "strip_age_days": 9.0,
            "estimated_dose": 480.0,
            "equivalent_8h_twa_ppm": 1.00,
            "confidence": 0.95,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.96,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 70.2, "a_star": 8.9, "b_star": 21.0}, "delta_e_baseline": 29.8})
        },
        {
            "id": "scan-1010",
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=14, hours=7),
            "shift": "Shift A",
            "temperature_c": 27.0,
            "humidity_pct": 59.0,
            "strip_age_days": 6.0,
        ...
        },
        {
            ...
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=18, hours=4),
            "shift": "Shift A",
            "temperature_c": 29.0,
            "humidity_pct": 67.0,
            "strip_age_days": 2.0,
            "estimated_dose": 720.0,
            "equivalent_8h_twa_ppm": 1.50,
            "confidence": 0.93,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.94,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 59.4, "a_star": 13.9, "b_star": 27.2}, "delta_e_baseline": 43.1})
        },
        {
            "id": "scan-1012",
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=22, hours=3),
            "shift": "Shift A",
            "temperature_c": 30.5,
            "humidity_pct": 71.0,
            "strip_age_days": 1.0,
        ...
        },
        {
            ...
            "worker_id": "w-01",
            "badge_id": "MRPL-H2S-8821",
            "timestamp": now - timedelta(days=26, hours=5),
            "shift": "Shift A",
            "temperature_c": 28.5,
            "humidity_pct": 64.0,
            "strip_age_days": 1.0,
            "estimated_dose": 798.0,
            "equivalent_8h_twa_ppm": 1.66,
            "confidence": 0.92,
            "status": "MODERATE",
            "expiry_status": "VALID",
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 56.5, "a_star": 15.2, "b_star": 28.8}, "delta_e_baseline": 46.5})
        },

        # Worker w-02 (Ananya Sharma / MRPL-EMP-4104) - 30-Day Sum: 4,180.0 ppm·min
        {
            "id": "scan-2001",
            "worker_id": "w-02",
        ...
        },
        {
            ...
            "humidity_pct": 60.0,
            "strip_age_days": 18.0,
            "estimated_dose": 350.0,
            "equivalent_8h_twa_ppm": 0.73,
            "confidence": 0.95,
            "status": "LOW",
            "expiry_status": "VALID",
            "image_quality_score": 0.96,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 76.8, "a_star": 6.5, "b_star": 18.5}, "delta_e_baseline": 22.8})
        },
        {
            "id": "scan-2003",
            "worker_id": "w-02",
        ...
        },
        {
            ...
            "worker_id": "w-02",
            "badge_id": "MRPL-H2S-8822",
            "timestamp": now - timedelta(days=7, hours=3),
            "shift": "Shift A",
            "temperature_c": 28.5,
            "humidity_pct": 61.0,
            "strip_age_days": 13.0,
        ...
        },
        {
            ...
            "worker_id": "w-02",
            "badge_id": "MRPL-H2S-8822",
            "timestamp": now - timedelta(days=10, hours=5),
            "shift": "Shift A",
            "temperature_c": 30.0,
            "humidity_pct": 68.0,
            "strip_age_days": 10.0,
        ...
        },
        {
            ...
            "worker_id": "w-02",
            "badge_id": "MRPL-H2S-8822",
            "timestamp": now - timedelta(days=14, hours=1),
            "shift": "Shift A",
            "temperature_c": 27.5,
            "humidity_pct": 57.0,
            "strip_age_days": 6.0,
            "estimated_dose": 580.0,
            "equivalent_8h_twa_ppm": 1.21,
            "confidence": 0.94,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.95,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 65.2, "a_star": 11.2, "b_star": 24.5}, "delta_e_baseline": 37.1})
        },
        {
            "id": "scan-2007",
            "worker_id": "w-02",
            "badge_id": "MRPL-H2S-8822",
            "timestamp": now - timedelta(days=18, hours=6),
            "shift": "Shift A",
            "temperature_c": 29.0,
            "humidity_pct": 67.0,
            "strip_age_days": 2.0,
            "estimated_dose": 715.0,
            "equivalent_8h_twa_ppm": 1.49,
            "confidence": 0.93,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.94,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 59.8, "a_star": 13.8, "b_star": 27.1}, "delta_e_baseline": 42.8})
        },
        {
            "id": "scan-2008",
            "worker_id": "w-02",
            "badge_id": "MRPL-H2S-8822",
            "timestamp": now - timedelta(days=24, hours=4),
            "shift": "Shift A",
            "temperature_c": 28.5,
            "humidity_pct": 63.0,
            "strip_age_days": 1.0,
            "estimated_dose": 800.0,
            "equivalent_8h_twa_ppm": 1.67,
            "confidence": 0.92,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.93,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 56.2, "a_star": 15.4, "b_star": 29.0}, "delta_e_baseline": 46.9})
        },

        # Worker w-03 (Vikram Patil / MRPL-EMP-3920) - 30-Day Sum: 1,920.0 ppm·min
        {
            "id": "scan-3001",
            "worker_id": "w-03",
        ...
        },
        {
            ...
            "humidity_pct": 60.0,
            "strip_age_days": 10.0,
            "estimated_dose": 320.0,
            "equivalent_8h_twa_ppm": 0.67,
            "confidence": 0.95,
            "status": "LOW",
            "expiry_status": "VALID",
            "image_quality_score": 0.96,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 78.1, "a_star": 6.1, "b_star": 18.0}, "delta_e_baseline": 21.0})
        },
        {
            "id": "scan-3003",
            "worker_id": "w-03",
            ...
            "humidity_pct": 58.0,
            "strip_age_days": 3.0,
            "estimated_dose": 450.0,
            "equivalent_8h_twa_ppm": 0.94,
            "confidence": 0.94,
            "status": "MODERATE",
            "expiry_status": "VALID",
            "image_quality_score": 0.95,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 71.1, "a_star": 8.6, "b_star": 20.8}, "delta_e_baseline": 28.9})
        },
        {
            "id": "scan-3004",
            "worker_id": "w-03",
            "badge_id": "MRPL-H2S-8823",
            "timestamp": now - timedelta(days=20, hours=5),
            "shift": "Shift B",
            "temperature_c": 29.0,
            "humidity_pct": 65.0,
            "strip_age_days": 1.0,
            "estimated_dose": 380.0,
            "equivalent_8h_twa_ppm": 0.79,
            "confidence": 0.95,
            "status": "LOW",
            "expiry_status": "VALID",
            "image_quality_score": 0.96,
            ...
            "source": "CAMERA",
            "warnings_json": json.dumps([]),
            "color_features_json": json.dumps({"cielab": {"L_star": 75.3, "a_star": 7.0, "b_star": 19.1}, "delta_e_baseline": 24.5})
        },
        {
            "id": "scan-3005",
            "worker_id": "w-03",
            "badge_id": "MRPL-H2S-8823",
            "timestamp": now - timedelta(days=27, hours=1),
            "shift": "Shift B",
            "temperature_c": 30.0,
            "humidity_pct": 63.0,
            "strip_age_days": 1.0,
        ...
        # Worker w-04 (Suresh Hegde / MRPL-EMP-4512) - High Exposure Alert Scenario
        {
            "id": "scan-4001",
            "worker_id": "w-04",
        ...
        # Worker w-05 (Pooja Nayak / MRPL-EMP-3881)
        {
            "id": "scan-5001",
            "worker_id": "w-05",
        ...
        # Worker w-07 (Mohammed Farooq / MRPL-EMP-4302)
        {
            "id": "scan-7001",
            "worker_id": "w-07",
        ...
        # Worker w-10 (Manoj Mendon / MRPL-EMP-3740) - Expired Badge Reading
        {
            "id": "scan-10001",
            "worker_id": "w-10",
